                    ...
                    <div class="col-lg-4 col-md-6 text-center">
                        <div class="single-product-item">
                            <div class="product-image">
                                <a href="procat.php?id=<?php echo  $fetch['Eid']  ?>"><img src="<?php echo  $img_path . $fetch['Eimage']  ?>" alt=""></a>
                            </div>
                            <h6><?php echo   $fetch['Ename']  ?></h6>
                            <p class="text"><?php echo  $fetch['Edescription']  ?></p>
                            <a href="procat.php?id=<?php echo  $fetch['Eid']  ?>" class="cart-btn"><i class="fas fa-book"></i> View
                            </a>
                        </div>
                    </div>
                <?php
